...
<div class="col-xs-12 alert alert-danger for_mobile">
  <h1 class="text-center">Non Disponible sur téléphone</h1>
</div>
...
<div class="col-xs-12">
  <div class="col-md-4 section_video" >
    <h2 class="text-center photo_title">N'importe quoi</h2>
    <video contextmenu="return false;" oncontextmenu="return false;" src="videos/bordel.mp4" controls  controlsList="nodownload" class="col-xs-12">
      N'importe quoi.
    </video>
  </div>
...
<div class="col-xs-12">
  ...
  <div class="col-md-4 section_video" >
    <h2 class="text-center photo_title">Zouk des mariés</h2>
    <video contextmenu="return false;" oncontextmenu="return false;" src="videos/zouk.mp4" controls  controlsList="nodownload" class="col-xs-12">
      Zouk des mariés
    </video>
  </div>
</div>
...
<div class="col-xs-12">
  <div class="col-md-4 section_video" >
    <h2 class="text-center photo_title">I like to move it</h2>
    <video contextmenu="return false;" oncontextmenu="return false;" src="videos/move_it.mp4" controls  controlsList="nodownload" class="col-xs-12">
      I like to move it.
    </video>
  </div>
</div>
